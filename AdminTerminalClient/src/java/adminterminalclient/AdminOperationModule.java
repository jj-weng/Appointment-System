...
public class AdminOperationModule {
    ...
    private void doViewCustAppointments() {
        ...
        try
        {
            ...
            if (customerId == 0L)
            {
                ...
                System.out.println(String.format("%20s | %20s | %20s | %20s | %20s", "Name", "Business category", "Date", "Time", "Appointment No."));
                ...
                else
                {
                    for (AppointmentEntity a : custAppts)
                    {
                        ...
                        System.out.println(String.format("%20s | %20s | %20s | %20s | %20s", fullName, cat.getCategoryName(), strDate, strTime, a.getAppointmentCode()));
                    }
                    System.out.println();
                }
        ...
        try {
            while (serviceProvId != 0) {
                try {
                    ...
                    System.out.println(String.format("%20s | %20s | %10s | %10s | %20s", "Customer name", "Business category", "Date", "Time", "Appointment No.", "Status"));
    ...
    private void doViewServiceProviders() {
        ...
        System.out.println(String.format("%10s | %20s | %20s | %20s | %20s | %20s | %20s | %20s | %20s", "Id", "Name", "Business category", "Business Reg. No.", "City", "Address", "Email", "Phone", "Status"));

        for (ServiceProviderEntity s : serviceProviders) {
            System.out.println(String.format("%10s | %20s | %20s | %20s | %20s | %20s | %20s | %20s | %20s", s.getServiceProviderId(), s.getName(), s.getCategory().getCategoryName(),
    ...
    private void doApproveServiceProvider() {
        ...
        try {
            ...
            System.out.println(String.format("%10s | %20s | %20s | %20s | %10s | %20s | %20s | %20s", "Id", "Name", "Business category", "Business Reg. No.", "City", "Address", "Email", "Phone"));
            ...
            for (ServiceProviderEntity s : pending) {
                System.out.println(String.format("%10s | %20s | %20s | %20s | %10s | %20s | %20s | %20s", s.getServiceProviderId(), s.getName(), s.getCategory().getCategoryName(),
                        s.getRegistrationNumber(), s.getCity(), s.getAddress(), s.getEmail(), s.getPhone()));
            }
            System.out.println();
